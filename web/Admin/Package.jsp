...
<html>
    <head>
        ...
        <title>KeralaTourism::PackageDetails</title>
    </head>
    <body>
      <%
        ...
        <form name="frmplace"><center>
                ...
                <table>
                    ...
                    <tr><td>PackageName</td><td> <input type="text" name="txtpackage" id="package" value="<%=packagename%>"></td></tr>
                    ...
                    <tr><td> <h2> <u>PackageList</u></h2></td></tr>
