            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (!file_name.equals("")) {
                            // if(field_name.equals("photo"))
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Admin\\PackageImages\\";
                                Random r = new Random();
                                int r_num = r.nextInt(1111) + 999;
                                
                                fn = "PackageImages_" + r_num + ext;
...
String id="";
String sel="select ifnull(max(package_id),1) as package_id from tbl_package";
ResultSet rs=obj.select(sel);
if(rs.next())
{
    id=rs.getString("package_id");
}
String up="insert into tbl_packageimages set package_image='"+fn+"',package_id='"+id+"'";
