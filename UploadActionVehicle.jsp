            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (!file_name.equals("")) {
                            // if(field_name.equals("photo"))
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Admin\\VehicleImages\\";
                                Random r = new Random();
                                int r_num = r.nextInt(1111) + 999;
                                
                                fn = "VehicleImages" + r_num + ext;
...
String id="";
String sel="select ifnull(max(vehicle_id),1) as vehicle_id from tbl_vehicle";
ResultSet rs=obj.select(sel);
if(rs.next())
{
    id=rs.getString("vehicle_id");
}
String up="update tbl_vehicle set vehicle_image='"+fn+"' where vehicle_id='"+id+"'";
